  ...
  "qa_list": [
    {
      ...
      "marks": 2,
      "question": "ભારતની પ્રાચીનતા વિશે વિષ્ણુપુરાણમાં શું કહેવામાં આવ્યું છે? (Board March 2020, 2022)",
      "answer": "<div style='background-color:#f0f8ff; padding:15px; border-left:5px solid #16a085; border-radius:8px;'><p><strong>ઉકેલ:</strong></p><p>વિષ્ણુપુરાણમાં ભારત વિશે નીચે મુજબનો શ્લોક અને તેનો અર્થ આપવામાં આવ્યો છે:</p><ul><li>શ્લોક: 'उत्तरं यत्समुद्रस्य हिमाद्रेश्चैव दक्षिणम् । वर्षं तद् भारतं नाम भारती यत्र सन्ततिः ॥'</li><li>અર્થાત્: સમુદ્રની ઉત્તરે અને હિમાલયની દક્ષિણે આવેલું જે સ્થળ છે તેનું નામ 'ભારતવર્ષ' છે.</li><li>જેના સંતાનો ભારતીય છે તેમ કહેવાયું છે.</li><li>ભારતમાં શુભ કાર્યની શરૂઆતમાં લેવાતા સંકલ્પોમાં ભારતવર્ષ, ભરતખંડ, જંબુદ્વીપ, આર્યાવર્ત જેવા શબ્દોનો ઉપયોગ થાય છે.</li></ul><hr><p style='color:#d32f2f; font-weight:bold;'>💡 નિતેશ સરની શોર્ટકટ ટ્રીક / યાદ રાખવાની રીત: ઉ-સમુદ્ર, દ-હિમાલય = ભારતવર્ષ (દિશાઓ યાદ રાખો).</p><p style='color:#64748b; font-size:14px;'><strong>Reference:</strong> GSEB Board / NJ Classes IMP</p></div>"
    },
    {
      "questionNumber": "પ્રશ્ન 2",
      "marks": 2,
      "question": "નદીઓને 'લોકમાતા' તરીકે શા માટે ઓળખવામાં આવે છે? (Board March 2019, July 2022)",
      "answer": "<div style='background-color:#f0f8ff; padding:15px; border-left:5px solid #16a085; border-radius:8px;'><p><strong>ઉકેલ:</strong></p><p>નદીઓને લોકમાતાનું બિરુદ મળ્યું છે કારણ કે:</p><ul><li>પ્રાચીન કાળથી નદીઓ આપણને પીવાનું પાણી, વપરાશનું પાણી અને સિંચાઈ માટે પાણી પૂરું પાડે છે.</li><li>નદીઓના કિનારે જ માનવ સંસ્કૃતિનો વિકાસ થયો છે (દા.ત. સિંધુ અને રાવી નદી).</li><li>વીજળી, ખેતી અને જળમાર્ગ જેવી મહત્વની જરૂરિયાતો નદીઓ દ્વારા સંતોષાય છે.</li><li>માટીના વાસણો, લીંપણ અને મકાનોના બાંધકામમાં નદીનું પાણી અનિવાર્ય છે.</li></ul><hr><p style='color:#d32f2f; font-weight:bold;'>💡 નિતેશ સરની શોર્ટકટ ટ્રીક / યાદ રાખવાની રીત: પાણી + સિંચાઈ + સંસ્કૃતિ = લોકમાતા.</p><p style='color:#64748b; font-size:14px;'><strong>Reference:</strong> GSEB Board / NJ Classes IMP</p></div>"
    },
    {
      "questionNumber": "પ્રશ્ન 3",
      "marks": 2,
      "question": "'સંસ્કૃતિ' એટલે શું? ટૂંકમાં સમજાવો.",
      "answer": "<div style='background-color:#f0f8ff; padding:15px; border-left:5px solid #16a085; border-radius:8px;'><p><strong>ઉકેલ:</strong></p><p>સંસ્કૃતિ એટલે:</p><ul><li>'સંસ્કૃતિ એટલે જીવન જીવવાની રીત' (Way of Life).</li><li>માનવ મનનું ખેડાણ અને તેમાં ઉતરેલી મૂલ્યો, આચાર-વિચાર, ધાર્મિક પરંપરાઓ અને રહેણીકરણીનો સરવાળો.</li><li>દેશ કે સમાજમાં કાળક્રમે બદલાતા સંજોગો મુજબ જનજીવનમાં આવતા પરિવર્તનો, સુધારા અને સામાજિક નીતિ-રીતિઓ.</li><li>સંસ્કૃતિ એટલે માનવ સમાજની ટેવો, મૂલ્યો અને આદર્શોનું ઉચ્ચતમ ધ્યેય તરફ લઈ જતું જોડાણ.</li></ul><hr><p style='color:#d32f2f; font-weight:bold;'>💡 નિતેશ સરની શોર્ટકટ ટ્રીક / યાદ રાખવાની રીત: સંસ્કૃતિ = જીવનની રીત + મનનું ખેડાણ.</p><p style='color:#64748b; font-size:14px;'><strong>Reference:</strong> NCERT New Syllabus / NJ Classes</p></div>"
    },
    {
      "questionNumber": "પ્રશ્ન 4",
      "marks": 2,
      "question": "ભારતીય વારસાના જતન અને સંરક્ષણ અંગેની આપણી બંધારણીય ફરજો જણાવો.",
      "answer": "<div style='background-color:#f0f8ff; padding:15px; border-left:5px solid #16a085; border-radius:8px;'><p><strong>ઉકેલ:</strong></p><p>ભારતીય બંધારણની કલમ 51 (ક) માં વારસાના જતન માટે નીચેની ફરજો દર્શાવી છે:</p><ul><li>આપણી સમન્વિત સંસ્કૃતિના સમૃદ્ધ વારસાનું મૂલ્ય સમજી તેની જાળવણી કરવી.</li><li>જંગલો, તળાવો, નદીઓ અને વન્ય પશુ-પક્ષીઓ સહિત કુદરતી પર્યાવરણનું રક્ષણ કરવું અને સજીવો પ્રત્યે દયા રાખવી.</li><li>જાહેર મિલકતોનું રક્ષણ કરવું અને હિંસાનો ત્યાગ કરવો.</li></ul><hr><p style='color:#d32f2f; font-weight:bold;'>💡 નિતેશ સરની શોર્ટકટ ટ્રીક / યાદ રાખવાની રીત: કલમ 51 (ક) માં 6, 7 અને 9 (છ, જ, ટ) અંગ્રેજી મૂળાક્ષરો મુજબની ફરજો.</p><p style='color:#64748b; font-size:14px;'><strong>Reference:</strong> Textbook Page 6</p></div>"
    },
    {
      "questionNumber": "પ્રશ્ન 5",
      "marks": 2,
      "question": "પ્રાકૃતિક વારસાના અંગ તરીકે 'વનસ્પતિ જીવન' સમજાવો.",
      "answer": "<div style='background-color:#f0f8ff; padding:15px; border-left:5px solid #16a085; border-radius:8px;'><p><strong>ઉકેલ:</strong></p><p>ભારતની પ્રજા પર્યાવરણપ્રેમી રહી છે, જેનો પુરાવો વનસ્પતિ પ્રેમ છે:</p><ul><li>ભારતમાં વડ, પીપળો અને તુલસીની પૂજા-ધૂપદીપ કરવામાં આવે છે.</li><li>વટસાવિત્રી વ્રતમાં વડની પૂજા કરવામાં આવે છે.</li><li>અનાજ, કઠોળ, તેલીબિયાંના છોડ અને ફળ-ફૂલોથી લહેરાતા ખેતરોએ માનવ જીવનને સમૃદ્ધ બનાવ્યું છે.</li><li>હરડે, બહેડા, આમળા, કુંવરપાઠું, અરડૂસી જેવી ઔષધીઓએ આપણું જીવન નિરોગી રાખ્યું છે.</li></ul><hr><p style='color:#d32f2f; font-weight:bold;'>💡 નિતેશ સરની શોર્ટકટ ટ્રીક / યાદ રાખવાની રીત: પૂજા (વડ-તુલસી) + ઔષધિ (હરડે-આમળા) = વનસ્પતિ વારસો.</p><p style='color:#64748b; font-size:14px;'><strong>Reference:</strong> GSEB IMP</p></div>"
    },
    {
      "questionNumber": "પ્રશ્ન 6",
      "marks": 2,
      "question": "નેગ્રિટો (હબસી) પ્રજા વિશે ટૂંકમાં માહિતી આપો.",
      "answer": "<div style='background-color:#f0f8ff; padding:15px; border-left:5px solid #16a085; border-radius:8px;'><p><strong>ઉકેલ:</strong></p><p>નેગ્રિટો અથવા નિગ્રો પ્રજા ભારતની સૌથી પ્રાચીન નિવાસી પ્રજા માનવામાં આવે છે:</p><ul><li>તેઓ આફ્રિકામાંથી બલુચિસ્તાનના માર્ગે ભારતમાં આવ્યા હતા.</li><li>શારીરિક લાક્ષણિકતાઓ: વર્ણ શ્યામ, 4 થી 5 ફૂટ ઊંચાઈ અને માથે વાંકડિયા વાળ ધરાવતા હતા.</li><li>ઇતિહાસકારોના મતે તેઓ ભારતની આદિ નિવાસી પ્રજા છે.</li></ul><hr><p style='color:#d32f2f; font-weight:bold;'>💡 નિતેશ સરની શોર્ટકટ ટ્રીક / યાદ રાખવાની રીત: શ્યામ + 4-5 ફૂટ + વાંકડિયા વાળ = નેગ્રિટો.</p><p style='color:#64748b; font-size:14px;'><strong>Reference:</strong> Class 10 SS Chapter 1</p></div>"
    },
    {
      "questionNumber": "પ્રશ્ન 7",
      "marks": 2,
      "question": "ઓસ્ટ્રેલોઇડ (નિષાદ) પ્રજાની લાક્ષણિકતાઓ જણાવો.",
      "answer": "<div style='background-color:#f0f8ff; padding:15px; border-left:5px solid #16a085; border-radius:8px;'><p><strong>ઉકેલ:</strong></p><p>આ પ્રજા અગ્નિ એશિયામાંથી આવી હતી. આર્યો તેમને 'નિષાદ' કહેતા હતા:</p><ul><li>શારીરિક લાક્ષણિકતાઓ: શ્યામ રંગ, લાંબું અને પહોળું માથું, ટૂંકું કદ અને ચપટું નાક.</li><li>તેમનું યોગદાન: માટીના વાસણો બનાવવા, ખેતી કરવી, સુતરાઉ કાપડનું વણાટકામ કરવું વગેરે કૌશલ્યો જાણતા હતા.</li><li>ભારતની કોલ અને મુંડા જાતિ, આસામની ખાસી પ્રજા અને નિકોબારની પ્રજામાં આ પ્રજાના લક્ષણો જોવા મળે છે.</li></ul><hr><p style='color:#d32f2f; font-weight:bold;'>💡 નિતેશ સરની શોર્ટકટ ટ્રીક / યાદ રાખવાની રીત: અગ્નિ એશિયા + ચપટું નાક + વણાટકામ.</p><p style='color:#64748b; font-size:14px;'><strong>Reference:</strong> NJ Classes IMP Note</p></div>"
    },
    {
      "questionNumber": "પ્રશ્ન 8",
      "marks": 2,
      "question": "ગુજરાતના સાંસ્કૃતિક વારસાના કોઈ પણ ચાર મહત્વના સ્થળોના નામ આપો.",
      "answer": "<div style='background-color:#f0f8ff; padding:15px; border-left:5px solid #16a085; border-radius:8px;'><p><strong>ઉકેલ:</strong></p><p>ગુજરાતમાં સાંસ્કૃતિક, પૌરાણિક અને પુરાતત્વીય મહત્વ ધરાવતા મુખ્ય સ્થળો નીચે મુજબ છે:</p><ul><li>1. લોથલ (ધોળકા તાલુકો) - પ્રાચીન બંદર.</li><li>2. રંગપુર (લીમડી તાલુકો, સુરેન્દ્રનગર).</li><li>3. ધોળાવીરા (કચ્છ જિલ્લો).</li><li>4. વડનગરનું કીર્તિ તોરણ અને જૂનાગઢનો અશોકનો શિલાલેખ.</li><li>5. મોઢેરાનું સૂર્યમંદિર.</li></ul><hr><p style='color:#d32f2f; font-weight:bold;'>💡 નિતેશ સરની શોર્ટકટ ટ્રીક / યાદ રાખવાની રીત: લોથલ-ધોળાવીરા (સિંધુ સંસ્કૃતિ) + મોઢેરા-વડનગર (ઐતિહાસિક).</p><p style='color:#64748b; font-size:14px;'><strong>Reference:</strong> Gujarat State Textbook</p></div>"
    },
    {
      "questionNumber": "પ્રશ્ન 9",
      "marks": 2,
      "question": "મોંગોલોઈડ (કિરાત) પ્રજા વિશે માહિતી આપો.",
      "answer": "<div style='background-color:#f0f8ff; padding:15px; border-left:5px solid #16a085; border-radius:8px;'><p><strong>ઉકેલ:</strong></p><p>આ પ્રજા ઉત્તર-પશ્ચિમ ચીનમાંથી તિબેટ થઈને ભારતમાં આવી હતી:</p><ul><li>તેમણે ઉત્તર આસામ, સિક્કિમ, ભૂતાન અને પૂર્વ બંગાળમાં વસવાટ કર્યો.</li><li>શારીરિક લાક્ષણિકતાઓ: પીળો વર્ણ, ચપટો ચહેરો, ઉપસેલા ગાલ અને બદામ આકારની આંખો.</li><li>પીળા વર્ણને કારણે તેઓ 'કિરાત' તરીકે પણ ઓળખાયા હતા.</li></ul><hr><p style='color:#d32f2f; font-weight:bold;'>💡 નિતેશ સરની શોર્ટકટ ટ્રીક / યાદ રાખવાની રીત: ચીન-તિબેટ + પીળો વર્ણ = મોંગોલોઈડ.</p><p style='color:#64748b; font-size:14px;'><strong>Reference:</strong> NCERT/GSEB Updated</p></div>"
    },
    {
      "questionNumber": "પ્રશ્ન 10",
      "marks": 2,
      "question": "પ્રાકૃતિક વારસો અને સાંસ્કૃતિક વારસા વચ્ચેનો તફાવત સ્પષ્ટ કરો.",
      "answer": "<div style='background-color:#f0f8ff; padding:15px; border-left:5px solid #16a085; border-radius:8px;'><p><strong>ઉકેલ:</strong></p><table><tr><td><strong>પ્રાકૃતિક વારસો</strong></td><td><strong>સાંસ્કૃતિક વારસો</strong></td></tr><tr><td>પ્રકૃતિ તરફથી મળેલી અમૂલ્ય ભેટ છે.</td><td>માનવીએ પોતાની બુદ્ધિ-શક્તિ અને આવડત દ્વારા મેળવેલું સર્જન છે.</td></tr><tr><td>તેમાં પર્વતો, નદીઓ, ઝરણાં અને વનસ્પતિનો સમાવેશ થાય છે.</td><td>તેમાં મંદિરો, શિલાલેખો, સ્તૂપો અને કિલ્લાઓનો સમાવેશ થાય છે.</td></tr></table><hr><p style='color:#d32f2f; font-weight:bold;'>💡 નિતેશ સરની શોર્ટકટ ટ્રીક / યાદ રાખવાની રીત: પ્રકૃતિ = કુદરતી | સંસ્કૃતિ = માનવસર્જિત.</p><p style='color:#64748b; font-size:14px;'><strong>Reference:</strong> Chapter 1 Basic Concepts</p></div>"
    },
    {
      "questionNumber": "પ્રશ્ન 11",
      "marks": 2,
      "question": "ગુજરાતના કોઈ પણ ચાર મેળાઓના નામ અને તેનું સ્થળ જણાવો.",
      "answer": "<div style='background-color:#f0f8ff; padding:15px; border-left:5px solid #16a085; border-radius:8px;'><p><strong>ઉકેલ:</strong></p><p>ગુજરાતના જાણીતા મેળાઓ નીચે મુજબ છે:</p><ul><li>1. તરણેતરનો મેળો - તરણેતર (સુરેન્દ્રનગર).</li><li>2. વૌઠાનો મેળો - ધોળકા (અમદાવાદ).</li><li>3. ભવનાથનો મેળો - ગિરનાર (જૂનાગઢ).</li><li>4. શામળાજીનો ગદાધર મેળો - શામળાજી (અરવલ્લી).</li><li>5. ડાંગ દરબારનો મેળો - આહવા (ડાંગ).</li></ul><hr><p style='color:#d32f2f; font-weight:bold;'>💡 નિતેશ સરની શોર્ટકટ ટ્રીક / યાદ રાખવાની રીત: વૌઠા-ગધેડા, તરણેતર-છત્રીઓ, ભવનાથ-મહાદેવ.</p><p style='color:#64748b; font-size:14px;'><strong>Reference:</strong> Textbook Table 1.1</p></div>"
    },
    {
      "questionNumber": "પ્રશ્ન 12",
      "marks": 2,
      "question": "દ્રવિડ સંસ્કૃતિની ધાર્મિક માન્યતાઓ વિશે બે વાક્યો લખો.",
      "answer": "<div style='background-color:#f0f8ff; padding:15px; border-left:5px solid #16a085; border-radius:8px;'><p><strong>ઉકેલ:</strong></p><ul><li>દ્રવિડોએ માતારૂપી દેવી (પાર્વતી) અને પિતૃરૂપી પરમાત્મા (શિવ) ની પૂજાની સમજ આપી.</li><li>ધૂપ, દીપ અને આરતી વડે પૂજા કરવાની રીત દ્રવિડોએ આપી હોવાનું મનાય છે.</li><li>પ્રકૃતિ પૂજા અને પશુ પૂજા એ પણ દ્રવિડોની ભેટ છે.</li><li>આર્યોના પ્રભુત્વ બાદ આ દેવોને આર્યોએ પણ સ્વીકારી લીધા હતા.</li></ul><hr><p style='color:#d32f2f; font-weight:bold;'>💡 નિતેશ સરની શોર્ટકટ ટ્રીક / યાદ રાખવાની રીત: માતા-પિતા પૂજા + ધૂપ-દીપ = દ્રવિડો.</p><p style='color:#64748b; font-size:14px;'><strong>Reference:</strong> NJ Classes SS IMP</p></div>"
    }
  ]
}
,
